#### SQS構造の判定
<p>
bestcorr.out の SQS が理想ランダム固溶体であるかを目的関数の数値だけで判断することは難しい.
例えば, 目的関数の値が $-0.95$ の SQS は, $-0.85$ の構造より優れていると言えるが,
理想ランダム固溶体を保証する明確な基準がないため, 結果的に両構造とも
ランダム固溶体とみなせる（またはその逆の）可能性もある.
理想ランダム固溶体（Bragg-Williams-Gorsky 近似が成り立つ合金）では,
同じサイトで同じ濃度をもつ等価な元素同士は入れ替えることが可能である.
...
ペアやトリプレットなどの相関関数を十分大きなカットオフですべて完璧に一致させることはほぼ不可能であり,
