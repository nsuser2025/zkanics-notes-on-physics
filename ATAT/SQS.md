...
#### corrdump オプション
<p>
-2: 2 体相関関数を計算する際のカットオフ</br>
-3: 3 体相関関数を計算する際のカットオフ</br>
-4: 4 体相関関数を計算する際のカットオフ</br>
格子定数を 1 とした FCC ランダム固溶体では </br>
第 1 近接距離は $\frac{\sqrt{2}}{2} \approx 0.71$ </br>
第 2 近接距離は $1.0$ </br> 
第 3 近接距離は $\sqrt{1.5} \approx 1.22$ </br>
...
Column 1: 2 $\cdots$ 2 体相関, 3 $\cdots$ 3 体相関
Column 2: 計算に含まれる近接原子間の距離. 意図した通りの近傍シェルを含んでいるか確認する.
