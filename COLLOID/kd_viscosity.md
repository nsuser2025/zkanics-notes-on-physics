...
<p>
固体粒子の半径 $70$ nm, 固体粒子密度 $2.2$, 液体密度 $1.15$, 質量分率 $70$ wt% のとき,</br>
...
<p>
前述条件のもとで, 吸着層をもつ固体粒子からなる懸濁液の $50$ wt% の有効体積分率は $0.357$ になる. 
従って, $70$ wt% の粘度は $50$ wt% の粘度の 8.2 倍になる.
</p>
$$
\begin{align}
\biggl(\frac{1-0.564/0.64}{1-0.357/0.64}\biggr)^{-2.5\times0.64}
&\approx 8.2
\end{align}
$$
